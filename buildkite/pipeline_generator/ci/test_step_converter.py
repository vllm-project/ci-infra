...
from ..utils.constants import DEFAULT_WORKING_DIR, Scripts
from .docker_plugins import build_plugin_for_test_step


def convert_multi_node_test_step(
...
def convert_test_step_to_buildkite_step(
    test_step: TestStep, container_image: str, config: PipelineGeneratorConfig
) -> BuildkiteStep:
    ...
    plugin_config = build_plugin_for_test_step(
