...
def get_amd_scenarios() -> List[AMDScenario]:
    """Get test scenarios for AMD mode."""
    return [
        AMDScenario(
            name="amd_default",
            description="Default AMD configuration"
        ),
        AMDScenario(
            name="amd_production",
...
def run_jinja_amd(scenario: AMDScenario, template_path: str, 
...
def run_python_amd(scenario: AMDScenario, test_pipeline_path: str,
