...
from .utils.constants import VLLM_ECR_URL, VLLM_ECR_REPO, PipelineMode
from .steps.group_steps import generate_amd_group
from .modes.ci_mode import generate_ci_pipeline
from .modes.fastcheck_mode import generate_fastcheck_pipeline
...
@click.command()
@click.option("--test_path", type=str, default=".buildkite/test-pipeline.yaml", help="Path to the test pipeline yaml file")
...
@click.option("--list_file_diff", type=str, default="", help="List of files in the diff between current branch and main (pipe-separated)")
...
@click.option("--output", type=str, default=".buildkite/pipeline.yaml", help="Output path for generated pipeline")
def main(test_path: str, run_all: str, nightly: str, list_file_diff: str, mirror_hw: str, 
         fail_fast: str, vllm_use_precompiled: str, cov_enabled: str, vllm_ci_branch: str,
         pipeline_mode: str, output: str):
